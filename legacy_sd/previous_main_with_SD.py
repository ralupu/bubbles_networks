...
bubble_res = pd.read_excel('data/ro/ResultResults_ro_bet_bubbles.xlsx', sheet_name='Breakdowns')
...
DF_bubble = pd.read_excel('data/ro/ResultResults_ro_bet_bubbles.xlsx', sheet_name='BUB (CVM= WB, CVQ=95%, L=0)')
# DF_bubble.index = pd.to_datetime(DF_bubble['Date'], format = '%d/%m/%Y')

DF_boom = pd.read_excel('data/ro/ResultResults_ro_bet_bubbles.xlsx', sheet_name='BMPH (CVM= WB, CVQ=95%, L=0)')
# DF_boom.index = pd.to_datetime(DF_boom['Date'], format = '%d/%m/%Y')

DF_burst = pd.read_excel('data/ro/ResultResults_ro_bet_bubbles.xlsx', sheet_name='BRPH (CVM= WB, CVQ=95%, L=0)')
# DF_burst.index = pd.to_datetime(DF_burst['Date'], format = '%d/%m/%Y')

DF_dcovar = pd.read_excel('data/ro/ResultResults_ro_bet_covars.xlsx', sheet_name='Delta CoVaR (K=95%)')
...
os.makedirs('legacy_sd/output', exist_ok=True)
results_S1.to_excel('legacy_sd/output/results_S1.xlsx')
results_S2.to_excel('legacy_sd/output/results_S2.xlsx')
results_S3.to_excel('legacy_sd/output/results_S3.xlsx')
