...
def parse_args(argv: Optional[List[str]] = None) -> argparse.Namespace:
    ...
    parser.add_argument(
        "--bubble-file",
        type=str,
        default="results/temporal_graphs.pkl",
        help="Bubble graph pkl file",
    )
    parser.add_argument(
        "--frm-file",
        type=str,
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Optional output figure path (default: figures/tgnn_forecast_performance_*.png)",
    )
